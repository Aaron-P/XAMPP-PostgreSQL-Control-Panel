...
type
  TfConfigUserDefined = class(TForm)
    ...
    mConfigMySQL: TMemo;
    mLogsMySQL: TMemo;
    mConfigPostgreSQL: TMemo;
    mLogsPostgreSQL: TMemo;
    ...
    lblMySQLConf: TLabel;
    lblMySQLLogs: TLabel;
    pnlPostgreSQL: TPanel;
    lblPostgreSQLConf: TLabel;
    lblPostgreSQLLogs: TLabel;
    pnlFileZilla: TPanel;
...
begin
  ...
  Config.UserConfig.PostgreSQL.Text := mConfigPostgreSQL.Text;
  ...
  Config.UserLogs.PostgreSQL.Text := mLogsPostgreSQL.Text;
...
begin
  ...
  mConfigPostgreSQL.Text := Config.UserConfig.PostgreSQL.Text;
  ...
  mLogsPostgreSQL.Text := Config.UserLogs.PostgreSQL.Text;
