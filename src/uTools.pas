...
begin
  ...
  try
    ...
    Config.ASPostgreSQL := mi.ReadBool('Autostart', 'PostgreSQL', false);
    ...
    Config.EnableModules.PostgreSQL := mi.ReadBool('EnableModules', 'PostgreSQL', true);
    ...
    Config.EnableServices.PostgreSQL := mi.ReadBool('EnableServices', 'PostgreSQL', true);
    ...
    Config.ServiceNames.PostgreSQL := mi.ReadString('ServiceNames', 'PostgreSQL', 'postgresql');
    ...
    Config.ServicePorts.PostgreSQL := mi.ReadInteger('ServicePorts', 'PostgreSQL', 5432);
    ...
    Config.UserConfig.PostgreSQL.DelimitedText := mi.ReadString('UserConfigs', 'PostgreSQL', '');
    ...
    Config.UserLogs.PostgreSQL.DelimitedText := mi.ReadString('UserLogs', 'PostgreSQL', '');
...
begin
  ...
  try
    ...
    mi.WriteBool('Autostart', 'PostgreSQL', Config.ASPostgreSQL);
    ...
    mi.WriteBool('EnableModules', 'PostgreSQL', Config.EnableModules.PostgreSQL);
    ...
    mi.WriteBool('EnableServices', 'PostgreSQL', Config.EnableServices.PostgreSQL);
    ...
    mi.WriteString('ServiceNames', 'PostgreSQL', Config.ServiceNames.PostgreSQL);
    ...
    mi.WriteInteger('ServicePorts', 'PostgreSQL', Config.ServicePorts.PostgreSQL);
    ...
    mi.WriteString('UserConfigs', 'PostgreSQL', Config.UserConfig.PostgreSQL.DelimitedText);
    ...
    mi.WriteString('UserLogs', 'PostgreSQL', Config.UserLogs.PostgreSQL.DelimitedText);
...
begin
  ...
  UserLogs.PostgreSQL := tStringList.Create;
  ...
  UserConfig.PostgreSQL := tStringList.Create;
  ...
  UserConfig.PostgreSQL.Delimiter := '|';
...
begin
  ...
  FreeAndNil(UserLogs.PostgreSQL);
  ...
  FreeAndNil(UserConfig.PostgreSQL);
